	...
	-44.400       15.2
    		...
    		\paragraph{Importing data from a DAT file in Origin:}
	    		\begin{enumerate}[I.]
	    			...
	    			\begin{figure}[h!]
	    				\centering
	    				\includegraphics[width=0.5\textwidth]{figures/fig_origin-dat-01.png}
	    			\end{figure}
	    			
	    			\item Insert step.
	    			\begin{figure}[h!]
	    				\centering
	    				\includegraphics[width=0.5\textwidth]{figures/fig_origin-dat-02.png}
	    			\end{figure}
	    			
	    			\item Insert step.
	    			\begin{figure}[h!]
	    				\centering
	    				\includegraphics[width=0.5\textwidth]{figures/fig_origin-dat-03.png}
	    			\end{figure}
	    			
	    			\item Insert step.
	    			\begin{figure}[h!]
	    				\centering
	    				\includegraphics[width=0.5\textwidth]{figures/fig_origin-dat-04.png}
	    			\end{figure}
	    			
	    			\item Insert step.
	    			\begin{figure}[h!]
	    				\centering
	    				\includegraphics[width=0.5\textwidth]{figures/fig_origin-dat-05.png}
	    			\end{figure}
